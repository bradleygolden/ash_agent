...
Manage large tool results and growing context with Progressive Disclosure features.
...
defmodule MyApp.Agents.EfficientAssistant do
  use Ash.Resource,
    domain: MyApp.Agents,
    extensions: [AshAgent.Resource]
...
- **Result Processors**: Truncate, summarize, or sample large tool results
- **Context Compaction**: Sliding window or token-based iteration management
