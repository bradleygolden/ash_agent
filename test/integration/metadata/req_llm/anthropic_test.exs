defmodule AshAgent.Integration.Metadata.ReqLLM.AnthropicTest do
  @moduledoc false
  ...
  defmodule TestAgent do
    @moduledoc false
    use Ash.Resource,
      domain: AshAgent.Integration.Metadata.ReqLLM.AnthropicTest.TestDomain,
  ...
  test "result has Metadata struct with cached_tokens field" do
    {:ok, result} = Runtime.call(TestAgent, %{message: "say hi"})
