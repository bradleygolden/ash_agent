defmodule AshAgent.Integration.ProgressiveDisclosureBamlTest do
  @moduledoc """
  Integration tests for Progressive Disclosure hooks using BAML with local qwen3 model.
  ...
  describe "tool result compaction with baml" do
    test "truncates large tool results to 100 characters" do
      ...
      defmodule ToolCompactionAgent do
        @moduledoc false
        use Ash.Resource,
          domain: AshAgent.Integration.ProgressiveDisclosureBamlTest.TestDomain,
        ...
        agent do
          provider :baml
          client :ollama, function: :ProgressiveDisclosureAgent
          output AshAgent.Integration.ProgressiveDisclosureBamlTest.TestOutput

          input do
            argument :prompt, :string, allow_nil?: false
          end

          hooks AshAgent.Integration.ProgressiveDisclosureBamlTest.ToolCompactionAgent.TruncateOnlyHooks
        end
      ...
      result = ToolCompactionAgent.call("Get the large data")
